# parameter import works
    ...
    Output
      ...
      $SEG$DATA_LIMITS
                [,1]       [,2]      [,3]
      [1,] -605.9172    8.06986  526.8401
      [2,] -124.8722 2439.43213 1496.3762
      ...
      $FORCE_PLATFORM$CORNERS[[1]]
           [,1] [,2] [,3] [,4]
      [1,]  508  508    0    0
      [2,]  464    0    0  464
      [3,]    0    0    0    0
      
      $FORCE_PLATFORM$CORNERS[[2]]
           [,1] [,2] [,3] [,4]
      [1,] 1017 1017  509  509
      [2,]  464    0    0  464
      [3,]    0    0    0    0
      ...
      $EVENT$TIMES
           [,1]  [,2] [,3] [,4]  [,5] [,6] [,7]
      [1,] 0.00 0.000 0.00 0.00 0.000 0.00 0.00
      [2,] 3.59 3.685 4.05 4.16 4.535 4.65 5.03
