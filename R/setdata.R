...
#' \code{c3dr} package for later export. The function call updates the data
#' (point and/or analog) and the appropriate parameters and header sections.
#' Note that not all parameters can be updated based on insufficient
#' information. For example, when using \code{c3d_setdata()} for updating the
...
#'
#' @param x A \code{c3d} object to be modified.
...
#'   generated by \code{\link{c3d_data}}. Defaults to \code{NULL}, which means
#'   that the point data will remain unchanged.
...
#'   generated by \code{\link{c3d_analog}}. Defaults to \code{NULL}, which means
#'   that the analog data will remain unchanged.
#'
